...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create machine-management-c7b1
  fly apps create machine-management-c7b1-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app machine-management-c7b1
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app machine-management-c7b1-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'machine-management-c7b1-staging' does not match app name in config file 'machine-management-c7b1'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name machine-management-c7b1-db
  fly postgres attach --app machine-management-c7b1 machine-management-c7b1-db

  fly postgres create --name machine-management-c7b1-staging-db
  fly postgres attach --app machine-management-c7b1-staging machine-management-c7b1-staging-db
  ```
