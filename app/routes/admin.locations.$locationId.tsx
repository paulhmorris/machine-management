...
export default function Location() {
  ...
  return (
    <>
      <h1>{location.name}</h1>
      <p className="mt-0.5 text-sm text-gray-500">Last updated {dayjs(location.updatedAt).format("M/D/YYYY h:mm A")}</p>
      <Form className="mt-4 space-y-4 sm:max-w-[16rem]" method="post">
        ...
        <Textarea
          ...
          maxLength={255}
        />
        <Select label="Campus" name="campusId" defaultValue={location.campus.id} required>
