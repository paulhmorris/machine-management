...
export default function Machine() {
  ...
  return (
    <>
      ...
      <p className="mt-0.5 text-sm text-gray-500">Last updated {dayjs(pocket.updatedAt).format("M/D/YYYY h:mm A")}</p>
      <Form
        onReset={(e) => {
      ...
      >
        ...
        <Input label="Floor" name="floor" placeholder="1" maxLength={12} defaultValue={pocket.floor ?? ""} />
        <Input label="Position" name="position" placeholder="1" type="number" defaultValue={pocket.position ?? 1} />
        <Textarea
          label="Description"
          name="description"
