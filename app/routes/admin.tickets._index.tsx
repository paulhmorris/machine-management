...
import { getAllTicketsWithCount, getTicketStatuses } from "~/models/ticket.server";
...
export default function TicketIndex() {
  ...
  const { items, requestSort, sortConfig } = useSortableData<typeof tickets>(tickets, {
    key: "updatedAt",
    direction: "desc",
  });
  ...
  return (
    <>
      ...
      <div className="mt-4">
        <TicketTable items={items} requestSort={requestSort} sortConfig={sortConfig} />
      </div>
    </>
  );
}
