...
export async function action({ params, request }: ActionFunctionArgs) {
  ...
  if (!ticket) {
    return json({ errors: { ticketId: ["Ticket not found"] } }, { status: 400 });
  }
  ...
  return redirectWithToast(`/admin/invoices/${updatedInvoice.id}/ticket`, session, {
...
export default function AddTicket() {
  ...
  return (
    <Form className="flex max-w-xs flex-col gap-3 sm:w-32" method="post" replace>
